...
**Step 2: Polish the dataset**
Once your dataset is imported to Crunch, there are some optional steps you can take to make it look more polished and more efficient to navigate. We suggest you click through these in order.
* [Giving the dataset a friendly name](http://support.crunch.io/crunch/crunch_dataset-properties.html)
* [Hiding some variables from view (e.g. “home_address”)](http://support.crunch.io/crunch/crunch_organizing-variables.html#hiding-unhiding-and-deleting-variables)
* [Organizing variables into folders](http://support.crunch.io/crunch/crunch_organizing-variables.html)
